...
onMounted(() => {
    ...
    formData.value = {
        ...
        details: page.props.modelData?.details || []
    };
});
...
const submitForm = async () => {
    try {
        ...
        const response = await axios.put(`/api/${modelName}/${formData.value.id}`, formData.value);
        ...
        <div class="max-w-7xl mx-auto">
            ...
            >
                ...
                <template #description>
                    <p>Modify the form below to update the {{ singularizeAndFormat(modelName).toLowerCase() }} details.</p>
