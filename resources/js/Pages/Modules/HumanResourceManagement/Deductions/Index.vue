...
const columns = ref([
    ...
    { label: "Is Mandatory", value: (row) => row.is_mandatory ? "Yes" : "No" },
    { label: "Deduction Type", value: (row) => row.deduction_type ? humanReadable(row.deduction_type) : "-" },
    { label: "Default Value", value: (row) => row.default_value ? row.default_value : "-" },
