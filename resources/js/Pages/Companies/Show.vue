...
const ownerDetails = ref([
    ...
    { label: "Email", value: (row) => row.created_by_user?.email || "-" },
    { label: "Mobile", value: (row) => row.created_by_user?.mobile || "-" },
    { label: "Landline", value: (row) => row.created_by_user?.landline || "-" },
    { label: "Description", value: (row) => row.created_by_user?.description || "-" },
    { label: "Website", value: (row) => row.created_by_user?.website || "-" },
]);
